...
You can load this project in RStudio by opening the file called 'Open-Science-Introduction.Rproj'.
...
Open-Science-Introduction.Rproj | Project file                     | Loads project 
